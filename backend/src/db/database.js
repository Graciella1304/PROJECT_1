...
async function seedDB() {
  ...
  if (catCount === 0) {
    await db.categories.insert([
      { name: 'Electronics', slug: 'electronics', icon: 'fa-mobile-alt', image: 'https://images.unsplash.com/photo-1498049794561-7780e7231661?w=400', createdAt: new Date() },
      { name: 'Fashion', slug: 'fashion', icon: 'fa-tshirt', image: 'https://images.unsplash.com/photo-1445205170230-053b83016050?w=400', createdAt: new Date() },
      { name: 'Home & Kitchen', slug: 'home-kitchen', icon: 'fa-home', image: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=400', createdAt: new Date() },
      { name: 'Sports', slug: 'sports', icon: 'fa-futbol', image: 'https://images.unsplash.com/photo-1571902943202-507ec2618e8f?w=400', createdAt: new Date() },
      { name: 'Beauty', slug: 'beauty', icon: 'fa-spa', image: 'https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=400', createdAt: new Date() },
      { name: 'Books', slug: 'books', icon: 'fa-book', image: 'https://images.unsplash.com/photo-1481627834876-b7833e8f5570?w=400', createdAt: new Date() },
      { name: 'Vehicles', slug: 'vehicles', icon: 'fa-car', image: 'https://images.unsplash.com/photo-1494976388531-d1058494cdd8?w=400', createdAt: new Date() },
      { name: 'Agriculture', slug: 'agriculture', icon: 'fa-seedling', image: 'https://images.unsplash.com/photo-1500937386664-56d1dfef3854?w=400', createdAt: new Date() },
    ])
  }
  ...
  if (prodCount === 0) {
    ...
    await db.products.insert([
      ...
      { name: 'Ordinateur Portable Dell', description: 'Dell Latitude Core i5, 8GB RAM, 256GB SSD. Parfait pour le bureau ou les études.', price: 750000, originalPrice: 950000, stock: 8, categoryId: catMap['electronics'], categoryName: 'Electronics', image: 'https://images.unsplash.com/photo-1593642632559-0c6d3fc62b89?w=500', featured: true, rating: 4.5, reviewsCount: 21, condition: 'Used', location: 'Musanze', sellerName: 'Alice Uwimana', sellerId: alice?._id, status: 'active', createdAt: new Date() },
      { name: 'Robe Africaine Traditionnelle', description: 'Belle robe africaine faite à la main. Tissu kitenge de haute qualité. Disponible en plusieurs tailles.', price: 35000, originalPrice: 50000, stock: 25, categoryId: catMap['fashion'], categoryName: 'Fashion', image: 'https://images.unsplash.com/photo-1590735213920-68192a487bc2?w=500', featured: true, rating: 4.8, reviewsCount: 67, condition: 'New', location: 'Kigali', sellerName: 'Alice Uwimana', sellerId: alice?._id, status: 'active', createdAt: new Date() },
      ...
      { name: 'Canapé 3 Places', description: 'Canapé 3 places en tissu beige, très confortable. En excellent état, légèrement utilisé.', price: 280000, originalPrice: 400000, stock: 2, categoryId: catMap['home-kitchen'], categoryName: 'Home & Kitchen', image: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=500', featured: false, rating: 4.4, reviewsCount: 12, condition: 'Used', location: 'Kigali', sellerName: 'Bob Nkurunziza', sellerId: bob?._id, status: 'active', createdAt: new Date() },
      { name: 'Vélo de Montagne', description: 'VTT 26 pouces avec 21 vitesses. Freins à disque, cadre aluminium léger. Parfait pour les routes rwandaises.', price: 120000, originalPrice: 180000, stock: 6, categoryId: catMap['sports'], categoryName: 'Sports', image: 'https://images.unsplash.com/photo-1485965120184-e220f721d03e?w=500', featured: false, rating: 4.5, reviewsCount: 19, condition: 'Used', location: 'Musanze', sellerName: 'Alice Uwimana', sellerId: alice?._id, status: 'active', createdAt: new Date() },
      ...
      { name: 'Set Perruques Naturelles', description: 'Collection de perruques naturelles de qualité supérieure. Cheveux naturels 100%, longue durée.', price: 85000, originalPrice: 120000, stock: 20, categoryId: catMap['beauty'], categoryName: 'Beauty', image: 'https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=500', featured: false, rating: 4.2, reviewsCount: 73, condition: 'New', location: 'Kigali', sellerName: 'Bob Nkurunziza', sellerId: bob?._id, status: 'active', createdAt: new Date() },
      { name: 'Moto Honda CB125', description: 'Honda CB125 2021 en parfait état. Faible kilométrage, documents complets. Idéale pour Kigali.', price: 2800000, originalPrice: 3500000, stock: 1, categoryId: catMap['vehicles'], categoryName: 'Vehicles', image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=500', featured: true, rating: 4.8, reviewsCount: 8, condition: 'Used', location: 'Kigali', sellerName: 'Alice Uwimana', sellerId: alice?._id, status: 'active', createdAt: new Date() },
      { name: 'Sacs de Haricots 50kg', description: 'Haricots rouges locaux frais récolte 2024. Prix par sac de 50kg. Disponible en grande quantité.', price: 65000, originalPrice: 80000, stock: 100, categoryId: catMap['agriculture'], categoryName: 'Agriculture', image: 'https://images.unsplash.com/photo-1500937386664-56d1dfef3854?w=500', featured: false, rating: 4.6, reviewsCount: 34, condition: 'New', location: 'Ruhango', sellerName: 'Bob Nkurunziza', sellerId: bob?._id, status: 'active', createdAt: new Date() },
    ])
  }
  ...
  if (actCount === 0) {
    await db.activities.insert([
      { type: 'user_register', description: 'New user registered: Bob Nkurunziza', userId: null, meta: {}, createdAt: new Date(Date.now() - 2 * 60 * 1000) },
      { type: 'order_placed', description: 'New order placed: KT-1015', userId: null, meta: { orderNumber: 'KT-1015' }, createdAt: new Date(Date.now() - 15 * 60 * 1000) },
      { type: 'product_listed', description: 'Product listed: Samsung Galaxy A54', userId: null, meta: {}, createdAt: new Date(Date.now() - 60 * 60 * 1000) },
      { type: 'order_delivered', description: 'Order KT-1012 marked as delivered', userId: null, meta: { orderNumber: 'KT-1012' }, createdAt: new Date(Date.now() - 2 * 60 * 60 * 1000) },
    ])
  }
}
